...
export class ApartmentService {
  ...
  searchApartment(
    ...
    return this.http.get(`http://localhost:8080/api/search-apartment?bedroom=${bedroom}&bathroom=${bathroom}&province_id=${province_id}&startPrice=${startPrice}&endPrice=${endPrice}&startTime=${startTime}&endTime=${endTime}`)
  }
}
